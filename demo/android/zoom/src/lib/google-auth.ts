// BASELINE: This app requests FULL calendar access via Google OAuth.
// Compare with the OAuthHub version which requests only Zoom meetings
// via a manifest pipeline, never seeing non-Zoom events.
